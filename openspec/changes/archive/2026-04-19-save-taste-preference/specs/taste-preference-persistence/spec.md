...
If preferences exist, the system SHALL display a summary and offer Quick Reply options「直接用 ✅」and「重新填 🔄」.

The preference summary SHALL follow the format: 「上次偏好：{fat} · {skin} · {consistency} · {taste}」using human-readable labels.
